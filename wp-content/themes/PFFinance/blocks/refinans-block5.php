  ...
  <div class="rb5-content row">
    ...
    <div class="diagram-position">
      ...
      <div class="diagram">
        ...
        <div class="diagram-blocks">
          <div class="diagram-img"><img src="<?php echo get_template_directory_uri(); ?>/img/gifts-img.jpg"/></div>
          <div class="diagram-text">
        ...
        <div class="diagram-blocks">
          <div class="diagram-img"><img src="<?php echo get_template_directory_uri(); ?>/img/case-img.jpg"/></div>
          <div class="diagram-text">
        ...
        <div class="diagram-blocks">
          <div class="diagram-img"><img src="<?php echo get_template_directory_uri(); ?>/img/planset-img.jpg"/></div>
          <div class="diagram-text">
