...
<section class="refinans-block11 cnt">
  ...
  <div class="rb11-content row">
    <div class="rb11-head">
      ...
      <p>1. Если Вас не волнует процент одобрения клиентов банками!</p>
      <p>2. Если Вы больше любите давать внутренние рассрочки!</p>
      <p>3. Если Вам деньги совсем не нужны!</p>
