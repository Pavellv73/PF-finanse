...
<section class="network-sec1 cnt">
  <div class="ns1-content row">
    <div class="rd-bg row"></div>
    <div class="video-block">
      <video class="bgvideo" autoplay="autoplay" muted="muted">
        <source src="<?php echo get_template_directory_uri(); ?>/img/videos/anim-04.mov"/>
      </video>
    </div>
    <div class="ns1-head">
      <h2>Внедрение и сопровождение системы потребительского кредитования для не сетевых точек продаж</h2>
